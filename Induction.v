...
Theorem add_comm : forall n m : nat,
  n + m = m + n.
Proof.
  intros n. induction n as [|n' IH1].
  -simpl. intros m. induction m as [|m' IH2].
    +reflexivity.
    +simpl. rewrite <- IH2. reflexivity.
  - simpl. intros m. rewrite -> IH1.
    induction m as [|m' IH3].
    +reflexivity.
    +simpl. rewrite IH3. reflexivity.
Qed.
...
Proof.
  ...
  - reflexivity.
  -simpl. rewrite IH. 
  replace (n' + S n') with (S n' + n') by now rewrite add_comm.
 reflexivity.
Qed.
...
Proof.
  intros n. induction n as [|n' IH].
  -reflexivity.
  -rewrite IH. simpl. rewrite negb_negb. reflexivity.
Qed.
...
Proof.
  intros n. induction n as [|n' IH].
  -reflexivity.
  -intros m. simpl. rewrite <- plus_n_Sm.
...
Proof.
  ...
  -intros n. simpl. rewrite mul_n_Sm. rewrite IH.
  rewrite add_comm. reflexivity.
Qed.
...
(** **** Exercise: 6 stars, standard (more_exercises)
...
Proof.
  ...
  -reflexivity.
  -rewrite andb_false_r. intros H. rewrite H. reflexivity.
Qed.
...
Proof.
  intros n. induction n as [|n' IH].
  -reflexivity.
  -simpl. intros m p. rewrite IH. rewrite add_assoc. reflexivity.
Qed.
...
Proof.
  intros n. induction n as [|n' IH].
  -reflexivity.
  -intros m p. simpl. rewrite IH. rewrite mult_plus_distr_r. reflexivity.
Qed.
...
Proof.
  intros b. induction b as [| b' IH | b' IH].
  -reflexivity.
  -reflexivity.
  -simpl. rewrite IH. rewrite add_0_r. rewrite add_0_r.
...
Example ex1: normalize (B1 (B0 (B1 (B0 (B0 (B0 Z)))))) = B1 (B0 (B1 Z)).
Proof. reflexivity. Qed.
...
Theorem double_nat_bin: forall n,
...
Proof.
  ...
  rewrite double_nat_bin. rewrite IHb. reflexivity.
  -simpl. rewrite add_0_r.  rewrite <- double_plus.
  rewrite double_nat_bin. rewrite IHb. rewrite incr_double. reflexivity.
Qed.
